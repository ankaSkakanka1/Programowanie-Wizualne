...
{
    // Deklaracja kontrolek (używamy ListBox zgodnie z sugestią)
    ...
    // Komunikacja nr 1: Konstruktor przyjmujący parametry
    public ProduktyForms(string infoOdMain)
    {
        ...
        // Dodawanie przykładowych produktów do ListBox
        ...
        // Akcja po kliknięciu przycisku (Click)
        btnDodaj.Click += (s, e) => {
